...
#include "qt/epgc/topbar.h"
#include "qt/epgc/forms/ui_topbar.h"
#include <QPixmap>
#include "qt/epgc/lockunlock.h"
#include "qt/epgc/qtutils.h"
#include "qt/epgc/receivedialog.h"
...
TopBar::TopBar(EPGCGUI* _mainWindow, QWidget *parent) :
...
void TopBar::updateBalances(const CAmount& balance, const CAmount& unconfirmedBalance, const CAmount& immatureBalance,
    ...
    // EPG Balance
    CAmount epgAvailableBalance = balance;
    // zEPG Balance
