...
#include "qt/epgc/dashboardwidget.h"
#include "qt/epgc/forms/ui_dashboardwidget.h"
...
DashboardWidget::DashboardWidget(EPGCGUI* parent) :
    PWidget(parent),
...
void DashboardWidget::loadWalletModel(){
    ...
    // update the display unit, to not use the default ("EPG")
    updateDisplayUnit();
}
...
bool DashboardWidget::loadChartData(bool withMonthNames) {
    ...
    chartData->amountsByCache = getAmountBy(); // pair EPG, zEPG
