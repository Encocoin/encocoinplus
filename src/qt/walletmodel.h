...
#ifndef EPGC_QT_WALLETMODEL_H
#define EPGC_QT_WALLETMODEL_H
...
/** Interface to EPGC wallet from Qt view code. */
...
public:
    ...
    CAmount getRequiredMasternodeCollateral(int nTier) const;
    CAmount getMinMasternodeCollateral() const;
